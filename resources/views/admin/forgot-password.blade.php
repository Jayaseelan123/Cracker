...
<head>
    ...
    <style>
        ...
        .success{ color:#166534; background: #dcfce7; padding: 10px; border-radius: 6px; font-size:14px; margin-bottom:16px; text-align:center; border: 1px solid #bbf7d0;}
...
<div class="login-card">
    ...
    <form method="POST" action="{{ route('admin.password.email') }}">
        ...
        <div class="field">
            ...
            <input id="email" type="email" name="email" placeholder="admin@example.com" value="{{ old('email') }}" required autofocus>
        </div>

        <button type="submit" class="btn-login">Send Reset Link</button>

        <a href="{{ route('admin.login') }}" class="back-link">&larr; Back to Login</a>
    </form>
</div>
