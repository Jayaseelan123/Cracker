            ...
            <form action="{{ route('admin.enquiry.customer') }}" method="GET" class="row g-3 align-items-center">
                ...
                <div class="col-md-3">
                    <div class="d-flex gap-2">
                        ...
                        @if(request('search'))
                            <a href="{{ route('admin.enquiry.customer') }}" class="btn btn-light btn-lg px-4 border">
                        ...
                        <tr>
                            ...
                            <td class="text-end pe-4">
                                <div class="d-flex justify-content-end gap-2">
                                    <a href="{{ route('admin.orders.view', $order->id) }}" class="btn btn-icon btn-light-primary" title="View Details">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="https://wa.me/91{{ $order->customer_phone }}" target="_blank" class="btn btn-icon btn-light-success" title="WhatsApp">
                        ...
                        <tr>
                            <td colspan="5" class="text-center py-5">
                                <div class="py-5">
                                    ...
                                    @if(request('search'))
                                        <a href="{{ route('admin.enquiry.customer') }}" class="btn btn-primary mt-3">Reset Search</a>
                                    @endif
                                </div>
                            </td>
                        </tr>
